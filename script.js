...
function initEventListeners() {
    ...
    if (domElements.checkoutForm) {
        domElements.checkoutForm.addEventListener('submit', (e) => {
            e.preventDefault();
            const formData = {
                name: domElements.checkoutForm.querySelector('#checkout-name')?.value || '',
                email: domElements.checkoutForm.querySelector('#checkout-email')?.value || '',
                phone: domElements.checkoutForm.querySelector('#checkout-phone')?.value || '',
                address: domElements.checkoutForm.querySelector('#checkout-address')?.value || ''
            };
